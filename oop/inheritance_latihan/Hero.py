class Hero:
    ...
    def gainExp(self, input):
        self.__exp += input
        if(self.__exp >= 100):
            self.levelUp = self.__exp//100  # dibagi dibulatkan kebawah
            self.__exp %= 100  # sisah pembagian
...
class HeroStrength(Hero):
    def __init__(self, name):
        super().__init__(name)
        self.health_pool = [0, 200, 300, 450, 500, 650]
        self.armor_pool = [2, 2.5, 3, 4.5, 5, 6.5]
        self.attPower_pool = [0, 20, 40, 60, 80, 100]
        self.levelUp = 1
